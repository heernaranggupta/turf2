            ...
            <section>
                <div class="en section_container active" section-language="en">
                    <div id="md_en" data-target="out_en" class="agreement_md"><h1>Return and Refund Policy</h1>
                        ...
                        <ul>
                            <li>
                                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Rebounce Turf, Next to Prime Shoppers, opp. Happy Residency, Vesu, Surat, Gujarat 395007.</p>
                            </li>
                            <li>
                        ...
                        <p>Next to Prime Shoppers, opp. Happy Residency, Vesu, Surat, Gujarat 395007</p>
