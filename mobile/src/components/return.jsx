      ...
      <section>
        <div class="en section_container active" section-language="en">
          <div id="md_en" data-target="out_en" class="agreement_md">
            ...
            <ul>
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Rebounce
                  Turf, Next to Prime Shoppers, opp. Happy Residency, Vesu,
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Rebounce Turf, accessible
                  from{" "}
                  <a
            ...
            <p>
              Next to Prime Shoppers, opp. Happy Residency, Vesu, Surat, Gujarat
              395007
            </p>
            <p>
