                ...
                <div class="en section_container active" section-language="en">
                    <div id="md_en" data-target="out_en" class="agreement_md"><h1>Privacy Policy</h1>
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ROONGTA FUN WORLD PVT. LTD., S.NO. 32/3, NEAR PRIME SHOPPERS VESU, SURAT.</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p><strong>Website</strong> refers to Rebounce Turf, accessible from <a href="http://turf.rebounce.in/" rel="external nofollow noopener" target="_blank">http://turf.rebounce.in/</a></p>
                            </li>
                            <li>
                        ...
                        <ul>
                            <li>
                                <p>By email: rebouncesurat@gmail.com</p>
                            </li>
                            <li>
                                <p>By phone number: 9725119988</p>
                            </li>
                        </ul>
                    </div>
